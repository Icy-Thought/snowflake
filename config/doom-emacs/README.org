...
** Customizations
*** Doom-Themes
Unpinning ~doom-themes~ allows us to access the latest modifications done to the themes available in the ~emacs-doom-themes~ repository!

#+begin_comment
The reason to why this is important is to access the most recent version of Ayu-Mirage due to it being updated slowly.
#+end_comment
